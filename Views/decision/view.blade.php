...
<form class="form-horizontal" action="{{ URL::route('task.store') }}" method="POST">
{{ csrf_field() }}
<fieldset>

<!-- Form Name -->
<legend>View Cabinet Decision Upload</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="ReferenceNo">Document Reference No</label>  
  <div class="col-md-5">
  <input id="ReferenceNo" name="ReferenceNo" placeholder="" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="DocumentDate" name="DocumentDate" placeholder="Document Date" class="form-control input-md" required="" type="text">
