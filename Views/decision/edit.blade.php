...
<form class="form-horizontal" action="{{ URL::route('decision.store') }}" method="POST" class="form-horizontal">
{{ csrf_field() }}
<fieldset>

<!-- Form Name -->
<legend>Edit Cabinet Decision Upload</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="ReferenceNo">Document Reference No</label>  
  <div class="col-md-5">
  <input id="ReferenceNo" name="ReferenceNo" value="{{ $row->ReferenceNo or 'DEFAULT' }}" placeholder="" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="DocumentDate" name="DocumentDate" value="{{ $row->DocumentDate or 'DEFAULT' }}" placeholder="" class="form-control input-md" required="" type="text">
